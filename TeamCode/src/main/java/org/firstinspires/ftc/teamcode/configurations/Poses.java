...
public class Poses {
    ...
    public static final double X_PGP_PATTERN_INIT_INCHES_RED = 52;
    public static final double X_PPG_PATTERN_INIT_INCHES_RED = 75;
    ...
    public static final double ANGLE_SHOOTING_FAR_FTC_RADIANS_BLUE      = Math.PI / 4 - 4 / 180 * Math.PI;
    public static final double Y_SHOOTING_FAR_FTC_INCHES_RED            = -16;
    public static final double ANGLE_SHOOTING_FAR_FTC_RADIANS_RED       = - Math.PI / 4 + 4 / 180 * Math.PI;
    ...
    public void initialize(Alliance alliance, Vision.Pattern pattern, boolean ShallParkInLaunchZone) {
        ...
        if (alliance == Alliance.RED) {
            ...
            if (pattern == Vision.Pattern.PPG) {
                mPositionPatternFTCInches = new Vector2d(X_PPG_PATTERN_FTC_INCHES_RED, Y_PATTERN_FTC_INCHES_RED);
                mPositionPatternInitInches = new Vector2d(X_PPG_PATTERN_INIT_INCHES_RED, Y_PATTERN_INIT_INCHES_RED);
            }
