...
@Autonomous
public class AutonomousGoalStartRobo extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        updatePoseFromAprilTagIfVisible();
            ...
            Actions.runBlocking(
                    mDrive.actionBuilder(mPath.shootingFar())
                            .setTangent(mPath.shootingFar().heading.toDouble() + Math.PI)
                            .splineToLinearHeading(mPath.parking(), mPath.parking().heading.toDouble() + Math.PI, new TranslationalVelConstraint(200), new ProfileAccelConstraint(-100,100))
                            .build());
