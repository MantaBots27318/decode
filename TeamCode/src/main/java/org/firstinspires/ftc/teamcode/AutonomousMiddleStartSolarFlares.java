...
@Autonomous
public class AutonomousMiddleStartSolarFlares extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                mDrive.actionBuilder(shootinit)
                        ...
                        .setTangent(-pattern.heading.toDouble())
                        .splineToLinearHeading(shootinit,-shootinit.heading.toDouble(), new TranslationalVelConstraint(50), new ProfileAccelConstraint(-15,15))
                        .build());
...
//        updatePoseFromAprilTagIfVisible();
        Actions.runBlocking(
                mDrive.actionBuilder(shootinit)
                        .lineToXConstantHeading(shootinit.position.x + 11, new TranslationalVelConstraint(100), new ProfileAccelConstraint(-50,50))
                        .build());
